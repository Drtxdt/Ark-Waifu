...
function createCdnConfig(
  ...
  if (canUseArkModelsCdn(operator)) {
    return [
      `<script`,
      `  src="https://cdn.jsdelivr.net/npm/ark-waifu@1.0.0/dist/ark-waifu.iife.js"`,
  ...
  return [
    `<script src="https://cdn.jsdelivr.net/npm/ark-waifu@1.0.0/dist/ark-waifu.iife.js" data-auto="false"></script>`,
